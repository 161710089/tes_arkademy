...
<form action="" method="POST"> 	
		...
		<?php if($id_product == 0){ 
			$button = "Add"; ?>
		  	<table class="table table-modal-arka">
			  	<tr>
			  		<td>
			  			<select class="form-control select-arka">
			  	...
			  	<tr>
			  		<td><input type="text" placeholder="Nama Barang" class="form-control input-arka"></td>
			  	</tr>
			  	<tr>
			  		<td><input type="text" placeholder="Harga" class="form-control input-arka"></td>
			  	</tr>

		  	</table>
		 <?php }elseif($id_product != 0){ $button = "Edit"; ?>
		 	<?php
			...
			?>
		 	<table class="table table-modal-arka">
			  	...
			  	<tr>
			  		<td><input type="text" placeholder="Nama Barang" value="<?= $product ?>" class="form-control input-arka"></td>
			  	</tr>
			  	<tr>
			  		<td><input type="text" placeholder="Harga" value="<?= $price ?>" class="form-control input-arka"></td>
			  	</tr>
	...
	<div class="modal-footer">
	  <button type="submit" class="btn btn-warning btn-arka" ><?= $button ?></button>
	</div>
</form>
